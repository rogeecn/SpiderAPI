...
module.exports = {
    ...
    <a href="https://www.qg.net/product/proxyip.html?web=spiderapi-s" target="_blank">
        <img src="https://static.wukongsec.com/spiderbox/images/ads/qg2.jpg" alt="qg" class="no-zoom" style="width: 100%;border-radius: 5px;">
    </a>
    ...
    <a href="https://netnut.cn/?utm_medium=partner&utm_source=spiderbox" target="_blank">
        <img src="https://static.wukongsec.com/spiderbox/images/ads/netnut_261x70.png" alt="netnut" class="no-zoom" style="width: 100%;border-radius: 5px;">
    </a>
